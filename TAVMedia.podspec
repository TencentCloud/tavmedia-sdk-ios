Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/TencentCloud/tavmedia-sdk-ios.git", :tag => "2.0.36" }
  ...
  spec.vendored_frameworks = "framework/FFmpeg.xcframework", "framework/TAVMedia.framework"
